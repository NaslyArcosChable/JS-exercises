// Obtenga la entrada del usuario usando el aviso ("Ingrese la edad del usuario :"). Si el usuario tiene 18 años o más,
// muestre el mensaje: 'Ya cuenta con la edad suficiente para conducir', pero si no tiene 18 años, coloca  otro mensaje 
// que indique que debe esperar la cantidad de años que aun le faltan por cumplir 18.


let edad = parseInt(prompt("Edad:"));

if (edad >= 18) {
  console.log('Ya tiene la edad  suficiente para conducir.');
} else {
  let añosEspera = 18 - edad;
  console.log('Aun te  faltan '+añosEspera+' años para  poder conducir.');
}
...
if (myAge > yourAge) {
  ...
  console.log("Tenemos la mismda edad .");
}
...
// Escriba un código que pueda calificar a los estudiantes de acuerdo con sus puntajes obenidos :
// ● 80-100, A
// ● 70-89, B
// ● 60-69, C
// ● 50-59, D
...
let calificacion = parseFloat(prompt("Ingrese la puntuacion del estudiante a calificar:"));
